...
- (UIView *)findView:(UIView *)aView withName:(NSString *)name {
    ...
    NSLog(@"%lu",(unsigned long)[aView.subviews count]);
	return nil;
}
...
//        UIView *PLCameraView = [[UIView alloc] init];
//        [viewController.view addSubview:PLCameraView];
        
        [viewController.view addSubview:deviceBtn];
        
        UILabel *label = [[UILabel alloc] init];
        label.text = @"拍下手表在紫色虚线上，即可快速找到手表";
        label.textAlignment = NSTextAlignmentCenter;
        label.numberOfLines =2;
        label.frame = CGRectMake(60, 20, 200, 50);
        ...
        //[overlyView addSubview:cameraOverlayView];
